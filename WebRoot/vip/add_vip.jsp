...
<html>
  <head>
    ...
    <title>My JSP 'add_vip.jsp' starting page</title>
	...
	<script type="text/javascript" src="js/generatVip.js"></script>
	<!-- 外部引入文件结束 -->
  ...
  <body>
    <br />
    <br />
    <p align = "center"><font face = "黑体" size = "5" color = "black">新增会员</font></p>
    <div>
    	<table>
    		<tr>
    			<th>会员号:</th>
    			<td>
    				<input type = "text" id = "vipNo" name = "vipNo" disabled="disabled">
    			</td>
    			<td>
    				<input type = "button" value = "点击生成会员号" onclick="generatVipNo()">
    			</td>
    		</tr>
