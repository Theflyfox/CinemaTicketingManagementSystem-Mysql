...
<%
	...
	request.getSession().setAttribute("postStr", postStr);
	request.getSession().setAttribute("filmId", request.getAttribute("filmId").toString());
...
<html>
  <head>
    ...
    <title>My JSP 'modify_film.jsp' starting page</title>
	...
	<script type = "text/javascript">
			...
			function checkAll() {
					...
					validateFilmOnline() && validateFilmContent() && validateFilmBackStory() && 
					validateFilmAward();
  ...
  <body>
    <BR />
  	<BR />
  	<p align = "center"><font face = "黑体" size = "5" color = "black">影片信息修改</font></p>
  	<div class="headeline"></div>
	<div id = "content">
    	<form action = "ModifyFilmInfoServlet" method="post">
		    <table border = "0">
		    
		    	<tr>
		    		<th class = "title" valign = 'top'>海报封面:</th>
		    		<td class = "inputContent">
	    					<a href = "film/modify_film_pic.jsp" target = "main">
	    						<img width = "315px" height = "400px" src ="posts/<%=postArr[0] %>"  alt = "图片"/>
	    					</a>
		    		</td>
		    	...
		    	<tr class = "title">
		    		<th>影片名:</th>
		    		<td class = "inputContent">
		    			<input type = "text" size = "43" name = "filmName" id = "fileName" checked = "checked" onblur="validateFileName();isShowroomNameExists();" onfocus="onfocusText('td_1')" value = "<%= map.get("filmname")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmAlias" id = "filmAlias" onblur="validateFilmAlias(this);" onfocus="onfocusText('td_2')" value = "<%= map.get("filmalais")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmCountry" id = "filmCountry"  onblur="validateFilmCountry(this);" onfocus="onfocusText('td_3')" value = "<%= map.get("filmcountry")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmDirector" id = "filmDirector" onblur="validateFilmDirector(this);" onfocus="onfocusText('td_4')" value = "<%= map.get("filmdirector")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmLeadingRole" id = "filmLeadingRole"  onblur="validateFilmLeadingRole(this);" onfocus="onfocusText('td_5')" value = '<%= map.get("filmleadingrole") %>'/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmLanguage" id = "filmLanguage"  onblur="validateFilmLanguage(this);" onfocus="onfocusText('td_6')" value = "<%= map.get("filmlanguage")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmLastTime" id = "filmLastTime"  onblur="validateFilmLastTime(this);" onfocus="onfocusText('td_7')" value = "<%= map.get("filmlasttime")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text"  size = "43" name = "filmType" id = "filmType"  onblur="validateFilmType(this);" onfocus="onfocusText('td_8')" value = "<%= map.get("filetype")%>"/>
		    		</td>
		    	...
		    	<tr>
		    		...
		    		<td class = "inputContent">
		    			<input type = "text" size = "43"  class = "Wdate" name = "filmOnline"  id = "filmOnline" onclick="WdatePicker()" onblur="validateFilmOnline(this);" onfocus="onfocusText('td_9')" value = "<%= map.get("filmonline")%>"/>
		    		</td>
		    	...
		    	<tr class = "centerContent">
		    		...
		    		<td>
		    			...
		    			<input type = "hidden" id = "filmId" name = "filmId" value = "<%=request.getAttribute("filmId").toString() %>"  />
		    		</td>
		    	</tr>
		    </table>
	    </form>
